...
function getDeleteFileUrl(
  fileType: DeleteFilePathParams["fileType"],
  fileName: DeleteFilePathParams["fileName"],
) {
  const res = {
    method: "DELETE",
...
export async function deleteFile(
  ...
  const res = await request<
    DeleteFileMutationResponse,
    ResponseErrorConfig<DeleteFile404>,
    unknown
  >({
    method: "DELETE",
    url: getDeleteFileUrl(fileType, fileName).url.toString(),
    ...requestConfig,
  });
  return res.data;
}
