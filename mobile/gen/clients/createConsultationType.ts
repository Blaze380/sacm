...
export async function createConsultationType(
  data: CreateConsultationTypeMutationRequest,
  config: Partial<RequestConfig<CreateConsultationTypeMutationRequest>> & {
    client?: Client;
  } = {},
) {
  ...
  >({
    method: "POST",
    url: getCreateConsultationTypeUrl().url.toString(),
    data: requestData,
    ...requestConfig,
  });
  return res.data;
